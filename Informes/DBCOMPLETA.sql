...
CREATE TABLE `carrito_de_compra` (
  ...
  `canal` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `categoria` VALUES (1,'Cocina','Cosas de la cocina'),(2,'Hardware','22'),(3,'Software','Licencias y servicios'),(4,'Accesori','Hola'),(5,'Sillas','Comodidad'),(6,'Cuchao','El rayo maquin'),(12,'Snacks','asd'),(13,'Snacks2',''),(14,'asd',''),(15,'asdasd2','');
...
CREATE TABLE `envio` (
  ...
  `personal_id` int DEFAULT NULL,
  `servicio_tracking` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `url_tracking` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `orden_de_compra` VALUES (1,2,2,'2025-12-03 12:04:44',450000.00,'ONLINE','PAGADA',4),(2,3,3,'2025-12-03 12:04:44',205000.00,'FISICO','PENDIENTE',4),(3,1,1,'2025-12-01 00:00:00',1000.00,'Teléfono','Entregado',1),(7,1,4,'2025-12-03 20:09:08',1000.00,'Web','PAGADA',NULL),(8,1,1,'2025-12-03 00:00:00',86666.00,'Teléfono','En proceso',1),(9,1,4,'2025-12-03 20:16:41',86666.00,'Web','PAGADA',NULL),(10,1,1,'2025-12-04 02:25:57',180000.00,'Web','PAGADA',NULL),(11,3,2,'2025-12-04 02:59:49',180000.00,'Web','PAGADA',NULL);
...
INSERT INTO `orden_de_pago` VALUES (1,1,1,450000.00,'ARS'),(2,2,2,205000.00,'USDT'),(3,7,1,1000.00,'USD'),(4,8,2,86666.00,'ARS'),(5,9,1,86666.00,'USD'),(6,10,1,180000.00,'ARS'),(7,11,2,180000.00,'ARS');
...
INSERT INTO `orden_producto` VALUES (1,3,1,450000.00),(2,4,2,180000.00),(2,6,1,25000.00),(3,2,1,1000.00),(9,7,1,86666.00),(10,4,1,180000.00);
...
INSERT INTO `producto` VALUES (1,1,'Aceite Buena vibra','999975846521',4500.00,'Agotado','2025-11-21 09:34:22'),(2,5,'Aceite Mala vibra','666',1000.00,'Agotado','2025-11-21 09:49:45'),(3,2,'Placa de video RTX 4060','RTX4060',450000.00,'ACTIVO','2025-12-03 12:04:44'),(4,6,'Motherboard B550M','MB-B550M',180000.00,'Disponible','2025-12-03 12:04:44'),(5,3,'Licencia Windows 11 Normal','WIN11PRO',120000.00,'Agotado','2025-12-03 12:04:44'),(6,4,'Mouse Gamer RGB','MOUSE-RGB',25000.00,'ACTIVO','2025-12-03 12:04:44'),(7,4,'Tecla3','67676',86666.00,'Disponible','2025-12-03 15:26:15'),(10,2,'mouse1','asd1234adsff',1231423.00,'Disponible','2025-12-03 22:40:25'),(11,1,'Aceite Mala vibra1','123asd12322',1233.00,'Disponible','2025-12-03 23:38:42'),(12,2,'Tecla4','66623',123.00,'Disponible','2025-12-03 23:56:21'),(13,3,'fifa','eafc24',123.00,'Disponible','2025-12-04 00:07:09'),(14,2,'Tecla6','lalals',123.00,'Disponible','2025-12-04 00:08:32'),(15,2,'mouse11','mooas',1234.00,'Disponible','2025-12-04 00:09:20');
...
INSERT INTO `stockmovimiento` VALUES (1,3,2,1,'2025-12-03 12:04:44',10,'Carga inicial'),(2,5,2,1,'2025-12-03 12:04:44',15,'Carga inicial'),(3,7,1,1,'2025-12-03 15:26:15',20,'Stock inicial de alta de producto'),(4,10,2,1,'2025-12-03 22:40:25',20,'Stock inicial de alta de producto'),(5,11,2,1,'2025-12-03 23:38:42',20,'Stock inicial de alta de producto'),(6,12,2,1,'2025-12-03 23:56:21',20,'Stock inicial de alta de producto'),(7,13,2,1,'2025-12-04 00:07:09',20,'Stock inicial de alta de producto'),(8,14,4,1,'2025-12-04 00:08:32',20,'Stock inicial de alta de producto'),(9,15,4,1,'2025-12-04 00:09:20',20,'Stock inicial de alta de producto');
...
INSERT INTO `stocksucursal` VALUES (3,2,10),(4,3,8),(5,2,15),(6,3,20),(7,1,20),(10,2,20),(11,2,20),(12,2,20),(13,2,20),(14,4,20),(15,4,20);
...
CREATE TABLE `transaccioncripto` (
  ...
  `wallet_cliente` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`pago_id`),
...
CREATE TABLE `usuarios` (
  ...
  `role` enum('empleado_lectura','gerente') COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `usuarios` VALUES (1,'empleado_lectura','14d9c36e0e278265f29bbb4085b828ab026fcf2eac38ed19e8e617bf0af75b74','b2e4f59ea57c6d49a14306411d182dea','empleado_lectura','2025-12-04 01:04:38'),(2,'gerente','12940b87066d7e96544120172ecf951ebb20855cf1adf82f3a075d389c4a2567','488e52afe0445099de69e2806c80cfff','gerente','2025-12-04 01:04:38');
...
INSERT INTO `usuarios_sistema` VALUES (1,'admin','admin123','admin'),(2,'vendedor','vendedor123','vendedor');
...
--
-- Temporary view structure for view `vista_resumen_ordenes`
--

DROP TABLE IF EXISTS `vista_resumen_ordenes`;
/*!50001 DROP VIEW IF EXISTS `vista_resumen_ordenes`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vista_resumen_ordenes` AS SELECT 
 1 AS `id_Orden`,
 1 AS `cliente`,
 1 AS `fecha`,
 1 AS `total`,
...
--
/*!50003 DROP FUNCTION IF EXISTS `generar_salt` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `generar_salt`() RETURNS varchar(32) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci
    DETERMINISTIC
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_verificar_password` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_verificar_password`(
    IN p_username VARCHAR(50),
...
/*!50001 VIEW `vista_productos_disponibles` AS select `p`.`id_Producto` AS `id_Producto`,`p`.`Nombre` AS `producto`,`c`.`Nombre` AS `categoria`,`p`.`Precio_Lista` AS `precio`,`p`.`Estado` AS `Estado` from (`producto` `p` join `categoria` `c` on((`p`.`categoria_id` = `c`.`id_Categoria`))) where (`p`.`Estado` = 'Disponible') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vista_resumen_ordenes`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_resumen_ordenes` AS select `o`.`id_Orden` AS `id_Orden`,concat(`cl`.`nombre`,' ',`cl`.`apellido`) AS `cliente`,`o`.`fecha` AS `fecha`,`o`.`total` AS `total`,`o`.`estado` AS `estado`,`s`.`nombre` AS `sucursal` from ((`orden_de_compra` `o` join `cliente` `cl` on((`o`.`cliente_id` = `cl`.`id_Cliente`))) join `sucursal` `s` on((`o`.`sucursalOrigen_id` = `s`.`id_Sucursal`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_resumen_ventas` AS select `s`.`nombre` AS `Sucursal`,date_format(`o`.`fecha`,'%Y-%m') AS `Mes`,count(`o`.`id_Orden`) AS `Cantidad_Ordenes`,sum(`o`.`total`) AS `Total_Ventas` from (`orden_de_compra` `o` join `sucursal` `s` on((`o`.`sucursalOrigen_id` = `s`.`id_Sucursal`))) where (`o`.`estado` = 'Entregado') group by `s`.`nombre`,date_format(`o`.`fecha`,'%Y-%m') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-12-04  0:16:49
